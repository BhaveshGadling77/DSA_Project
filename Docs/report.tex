...
\begin{center}
    ...
    \textit{submitted in partial fulfillment of the requirements for completion of}\\
    \textbf{Data Structures and Algorithms - 2 Lab}\\
    \textit{of}\\[0.5cm]
    ...
    {\Large \textbf{Computer Engineering}}\\[2cm]
    
    \textit{by}\\[0.5cm]
    
    {\Large \textbf{Sumit Vitthal Desai, Piyush Deshpande and Bhavesh Gadling}}\\[0.2cm]
    {\large 612415049, 612415052 and 612415061}\\[2cm]
    
    \textit{Under the guidance of}\\[0.5cm]
    
    {\Large \textbf{Prof. Tina Francis}}\\
    \textit{Professor}\\
    \textit{Department of Computer Engineering}\\[2cm]
    
    \textbf{Department of Computer Engineering,}\\
    \textbf{COEP Technological University (COEP Tech)}\\
...
\begin{itemize}
    ...
    \item \textbf{Limited Security Features:} Passwords are stored in plain text and role permissions are basic. The system is not designed for high-security environments.
